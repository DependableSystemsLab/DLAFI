...
#define RAND 1
    ...
    // fi_config(uint64_t tile_row, uint64_t tile_col, uint64_t pe_row, 
//     uint64_t pe_col, uint64_t fault_model, uint64_t do_fi, uint64_t fault_data){
