...
if [ -f "$FILE" ]; then
    ...
    wget https://media.githubusercontent.com/media/onnx/models/refs/heads/main/validated/vision/classification/alexnet/model/bvlcalexnet-12.onnx
fi

printf "\n[Compile Script]: Convert TF model to LLVM IR\n"
onnx-mlir --EmitLLVMIR  --instrument-onnx-ops="ALL" --InstrumentBeforeAndAfterOp bvlcalexnet-12.onnx --lltfi-fi 
mlir-translate -mlir-to-llvmir bvlcalexnet-12.onnx.mlir > model.mlir.ll
