...
FILE=shufflenet-v2-10.onnx
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else
    echo "$FILE does not exist."
    wget https://media.githubusercontent.com/media/onnx/models/refs/heads/main/validated/vision/classification/shufflenet/model/shufflenet-v2-10.onnx
fi
