...
$LLFI_BUILD_ROOT/bin/profile ./llfi/model-profiling.exe "input${$1}_0.pb" "input${$1}_1.pb" "input${$1}_2.pb" 0
echo "Generated model-profiling.exe"
$LLFI_BUILD_ROOT/bin/injectfault ./llfi/model-faultinjection.exe "input${$1}_0.pb" "input${$1}_1.pb" "input${$1}_2.pb" 0
